...
- Correr: `cd C:\AMP\fronted && npm run dev` → localhost:3000
- TypeScript: 0 errores (verificar con `npx tsc --noEmit`)
- Todos los datos son mocks en `lib/mock/` — sin backend real aún
