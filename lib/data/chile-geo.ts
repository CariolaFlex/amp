...
export const REGIONES_CHILE: Region[] = [
  ...
  },
  {
    ...
    comunas: ['Chillán', 'Bulnes', 'Chillán Viejo', 'El Carmen', 'Pemuco', 'Pinto', 'Quillón', 'San Ignacio', 'Yungay', 'Cobquecura', 'Coelemu', 'Ninhue', 'Portezuelo', 'Quirihue', 'Ránquil', 'Trehuaco', 'Coihueco', 'Ñiquén', 'San Carlos', 'San Fabián', 'San Nicolás'],
  },
  {
    codigo: 'VIII',
...
export function getComunasByRegion(regionNombre: string): string[] {
