    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">{mockOportunidades.length} oportunidades</p>
        </div>
      ...
      <DataTable
        ...
        actions={() => (
          <>
            ...
            <DropdownMenuItem className="text-xs">Editar etapa</DropdownMenuItem>
            <DropdownMenuItem className="text-xs">Registrar actividad</DropdownMenuItem>
          </>
        )}
